...
<?php require_once 'header.php'; ?>
	<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:#00203FFF">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">Natural Store</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home</a></li>
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span>Product</a></li>
				<li><a href="#"><span class="glyphicon glyphicon-paste"></span>About Us</a></li>
		<li><a href="#"><span class="glyphicon glyphicon-earphone"></span>Contact Us</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="customer_registration.php?register=1"><span class="glyphicon glyphicon-user"></span>Sign In</a></li>
			</ul>
		</div>
	</div>
</div>	
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-2 col-xs-12">
				...
				<div class="nav nav-pills nav-stacked">
		<li class="active"><a href="farmersfeed.php"style= "background-color:#333D79FF"><h4>Farmers</h4></a></li>
		</div>
			</div>
